...
from src.models import EarlyFusionModel2D
...
def main():
    ...
    parser.add_argument("--freeze_backbone", action="store_true", help="Freeze backbone and only train first conv + classifier")
    ...
    checkpoint_dir = Path(f"checkpoints/early_fusion_2d_{args.dataset}")
